...
# NEW: forward problem info into the compile-script sandbox
if [ -n "$PROBLEM_SHORTNAME" ]; then
    ENVIRONMENT_VARS="$ENVIRONMENT_VARS -V PROBLEM_SHORTNAME=$PROBLEM_SHORTNAME"
fi
