...
class JudgeTask
{
    ...
    /**
     * Transient field: attached at runtime for judgehost only.
     * Not stored in the DB.
     *
     * @Serializer\SerializedName("problem_id")
     * @Serializer\Type("integer")
     */
    private ?int $problem_id = null;

    /**
     * Transient field: attached at runtime for judgehost only.
     * Not stored in the DB.
     *
     * @Serializer\SerializedName("problem_shortname")
     * @Serializer\Type("string")
     */
    private ?string $problem_shortname = null;
    ...
    public function setProblemId(?int $problemId): JudgeTask
    {
    ...
    public function setProblemShortname(?string $shortname): JudgeTask
    {
        $this->problem_shortname = $shortname;
        return $this;
    }

    public function getProblemShortname(): ?string
    {
        return $this->problem_shortname;
    }
